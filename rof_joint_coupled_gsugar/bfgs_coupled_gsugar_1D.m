...
% coupled functional for fractal process segmentation using BFGS algorithm 
...
function [x,lbd] = bfgs_coupled_gsugar_1D(L,maxit,lbd_in)
    ...
    [~,sugar] = SURE_SUGAR_coupled_GRANSO_1D(L, lbd_i, sure, S);
    ...
    SURE_SUGAR = @(lbd) SURE_SUGAR_coupled_GRANSO_1D(L, lbd, sure, S);
