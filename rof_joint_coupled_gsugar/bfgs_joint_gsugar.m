...
% joint functional for fractal texture segmentation using BFGS algorithm 
...
function [x,lbd] = bfgs_joint_gsugar(L,maxit,lbd_in)
    ...
    [~,sugar] = SURE_SUGAR_joint_GRANSO(L, lbd_i, sure, S);
    ...
    SURE_SUGAR = @(lbd) SURE_SUGAR_joint_GRANSO(L, lbd, sure, S);
